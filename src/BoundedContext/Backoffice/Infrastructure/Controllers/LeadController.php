...
class LeadController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('backoffice.affiliateManagement.leads.index');
    }
    ...
    public function create()
    {
        ...
        return view('backoffice.affiliateManagement.leads.create', compact('affiliate_campaigns'));
    }
    ...
    public function edit(Lead $lead)
    {
        ...
        return view('backoffice.affiliateManagement.leads.edit', compact('affiliate_campaigns', 'lead'));
    }
    ...
    public function show(Lead $lead)
    {
        ...
        return view('backoffice.affiliateManagement.leads.show', compact('lead'));
    }
