...
class DocumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backoffice.advertiserManagement.documents.index');
    }
    ...
    public function create()
    {
        ...
        return view('backoffice.advertiserManagement.documents.create', compact('stores'));
    }
    ...
    public function edit(Document $document)
    {
        ...
        return view('backoffice.advertiserManagement.documents.edit', compact('document', 'stores'));
    }
    ...
    public function show(Document $document)
    {
        ...
        return view('backoffice.advertiserManagement.documents.show', compact('document'));
    }
