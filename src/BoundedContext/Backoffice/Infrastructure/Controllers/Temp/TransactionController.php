...
class TransactionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('backoffice.temp.transactions.index');
    }
    ...
    public function create()
    {
        ...
        return view('backoffice.temp.transactions.create', compact('currencies', 'income_sources', 'projects', 'transaction_types'));
    }
    ...
    public function edit(Transaction $transaction)
    {
        ...
        return view('backoffice.temp.transactions.edit', compact('currencies', 'income_sources', 'projects', 'transaction', 'transaction_types'));
    }
    ...
    public function show(Transaction $transaction)
    {
        ...
        return view('backoffice.temp.transactions.show', compact('transaction'));
    }
