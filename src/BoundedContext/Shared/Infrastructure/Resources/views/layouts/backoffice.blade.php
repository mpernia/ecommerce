...
<head>
    ...
    <title>{{ trans('setting.site_title') }}</title>
    <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/css/bootstrap.min.css" rel="stylesheet" />
    <link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.5/css/select2.min.css" rel="stylesheet" />
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/css/bootstrap-datetimepicker.min.css" rel="stylesheet" />
    <link href="{{ asset('assets/backoffice/css/adminltev3.css') }}" rel="stylesheet" />
            ...
            <ul class="navbar-nav ml-auto">
                @if(count(config('setting.available_languages', [])) > 1)
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link" data-toggle="dropdown">{{ strtoupper(app()->getLocale()) }}</a>
                ...
                <li class="nav-item dropdown show">
                    <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                        <div class="image mr-2">
                            <img src="{{ URL::asset('assets/backoffice/images/avatar-user.svg') }}" class="img-circle elevation-2" alt="User Image">
                        </div>
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right " style="left: inherit; right: 0px;">
                        ...
                        <a href="{{ route('profile.edit') }}" class="dropdown-item">
                            <i class="fas fa-user mr-2"></i> {{ trans('global.my_profile') }}
                        </a>
                        <a href="{{ route('profile.editTwoFactor') }}" class="dropdown-item">
                            <i class="fas fa-user-shield mr-2"></i> {{ trans('global.two_factor.title') }}
                        </a>
                        @if(file_exists(authControllerPath('ChangePasswordController')))
                            @can('profile_password_edit')
                                <div class="dropdown-divider"></div>
                                <a href="{{ route('profile.password.edit') }}" class="dropdown-item {{ request()->is('profile/password') || request()->is('profile/password/*') ? 'c-active' : '' }}">
                                    <i class="fas fa-key mr-2"></i> {{ trans('global.change_password') }}
                                </a>
                            @endcan
                        @endif
                        <div class="dropdown-divider"></div>
