...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.apiUser.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('backoffice.api-users.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('last_login_at') ? 'is-invalid' : '' }}" type="text" name="last_login_at" id="last_login_at" value="{{ old('last_login_at') }}">
