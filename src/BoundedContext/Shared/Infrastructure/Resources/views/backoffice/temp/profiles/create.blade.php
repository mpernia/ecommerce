...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("backoffice.profiles.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_surname') ? 'is-invalid' : '' }}" type="text" name="first_surname" id="first_surname" value="{{ old('first_surname', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('second_surname') ? 'is-invalid' : '' }}" type="text" name="second_surname" id="second_surname" value="{{ old('second_surname', '') }}">
