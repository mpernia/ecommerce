...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("backoffice.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('backoffice.content-pages.storeCKEditorImages') }}', true);
...
<script>
    ...
    url: '{{ route('backoffice.content-pages.storeMedia') }}',
    maxFilesize: 2, // MB
