...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("backoffice.products.update", [$product->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('specification') ? 'is-invalid' : '' }}" name="specification" id="specification">{!! old('specification', $product->specification) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference') ? 'is-invalid' : '' }}" type="text" name="reference" id="reference" value="{{ old('reference', $product->reference) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('availability') ? 'is-invalid' : '' }}" name="availability" id="availability">
                    ...
                    @foreach($availability as $key => $label)
                        <option value="{{ $key }}" {{ old('availability', $product->availability) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('brand') ? 'is-invalid' : '' }}" type="text" name="brand" id="brand" value="{{ old('brand', $product->brand) }}">
                @if($errors->has('brand'))
