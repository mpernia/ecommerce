...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("backoffice.product-categories.update", [$productCategory->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
...
<script>
    ...
    url: '{{ route('backoffice.product-categories.storeMedia') }}',
    maxFilesize: 2, // MB
