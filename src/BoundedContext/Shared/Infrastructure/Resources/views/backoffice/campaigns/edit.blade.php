...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("backoffice.campaigns.update", [$campaign->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ $campaign->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $campaign->url) }}" required>
                @if($errors->has('url'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('utm_source') ? 'is-invalid' : '' }}" type="text" name="utm_source" id="utm_source" value="{{ old('utm_source', $campaign->utm_source) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('utm_campaign') ? 'is-invalid' : '' }}" type="text" name="utm_campaign" id="utm_campaign" value="{{ old('utm_campaign', $campaign->utm_campaign) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('utm_term') ? 'is-invalid' : '' }}" type="text" name="utm_term" id="utm_term" value="{{ old('utm_term', $campaign->utm_term) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('utm_content') ? 'is-invalid' : '' }}" type="text" name="utm_content" id="utm_content" value="{{ old('utm_content', $campaign->utm_content) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pay_per_clic') ? 'is-invalid' : '' }}" type="number" name="pay_per_clic" id="pay_per_clic" value="{{ old('pay_per_clic', $campaign->pay_per_clic) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_per_lead') ? 'is-invalid' : '' }}" type="number" name="cost_per_lead" id="cost_per_lead" value="{{ old('cost_per_lead', $campaign->cost_per_lead) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_per_acquisition') ? 'is-invalid' : '' }}" type="number" name="cost_per_acquisition" id="cost_per_acquisition" value="{{ old('cost_per_acquisition', $campaign->cost_per_acquisition) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cost_per_clic') ? 'is-invalid' : '' }}" type="number" name="cost_per_clic" id="cost_per_clic" value="{{ old('cost_per_clic', $campaign->cost_per_clic) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('persent_per_sale') ? 'is-invalid' : '' }}" type="number" name="persent_per_sale" id="persent_per_sale" value="{{ old('persent_per_sale', $campaign->persent_per_sale) }}" step="0.01" max="100">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('products') ? 'is-invalid' : '' }}" name="products[]" id="products" multiple>
                    @foreach($products as $id => $product)
                        <option value="{{ $id }}" {{ (in_array($id, old('products', [])) || $campaign->products->contains($id)) ? 'selected' : '' }}>{{ $product }}</option>
                    @endforeach
                </select>
